    ...
    <div className="buffer-site">
      ...
      <main id="main">
        ...
        <section id="method" className="buffer-section buffer-method">
          ...
          <div className="buffer-steps"><article><span>01</span><h3>Choose an account</h3><p>Explore fixed samples or look up a public Velocity or legacy Drift authority and select a subaccount.</p></article><article><span>02</span><h3>Set the price move</h3><p>Apply one percentage move to eligible perpetual prices. Position quantities stay fixed.</p></article><article><span>03</span><h3>Follow the contribution</h3><p>Read the per-position effect, quote-currency totals, and exclusions. Export the details.</p></article></div>
        ...
        <section id="privacy" className="buffer-privacy"><div className="buffer-privacy-mark"><Mark size={43} /></div><h2>Curiosity shouldn’t<br />need your keys.</h2><div><p>Buffer never asks for a seed phrase, private key, or trading approval. Public account reads use an RPC provider. Save scenarios on your device without signing in. Optional cloud accounts keep a separate private library.</p><Link className="buffer-text-link" href="/app">Save your perspective <Icon name="arrow" size={17} /></Link></div></section>
