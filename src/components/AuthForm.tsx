  ...
  return <main className={styles.page}>
    ...
    <section className={styles.card}>
      ...
      <div className={styles.form}>
        ...
        {!configured ? <div role="status"><p>Cloud accounts are being configured. You can explore every sample and download scenario reports now.</p><a className="button primary" href="/app">Open the explorer</a></div> : <form onSubmit={submit}>
