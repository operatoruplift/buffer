...
export const DESIGN_MEDIA = {
  ...
  positions: { src: '/videos/design/positions.mp4', poster: '/videos/design/positions-poster.webp' },
  coverage: { src: '/videos/design/coverage.mp4', poster: '/videos/design/coverage-poster.webp' },
  math: { src: '/videos/design/math.mp4', poster: '/videos/design/math-poster.webp' },
  auth: { src: '/videos/design/auth.mp4', poster: '/videos/design/auth-poster.jpg' },
} as const;
