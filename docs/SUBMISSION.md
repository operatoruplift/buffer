...
Built with Next.js, React, TypeScript, precise decimal arithmetic, the official Velocity and legacy Drift SDKs, and Supabase. An original cobalt B monogram and restrained responsive interface keep the emphasis on understanding position effects. The source is public and the website is deployed on Vercel.
